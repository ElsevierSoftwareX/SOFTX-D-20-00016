...
def video_to_frames(video_path, output_folder, output_frame_filename, output_frame_extension):
    """
...
video_to_frames(input_file_path, output_folder, output_frame_filename, output_frame_extension)